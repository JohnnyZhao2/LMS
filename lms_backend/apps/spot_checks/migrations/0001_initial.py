    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checker', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='spot_checks_created', to=settings.AUTH_USER_MODEL, verbose_name='抽查人')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='spot_checks_received', to=settings.AUTH_USER_MODEL, verbose_name='被抽查学员')),
            ],
            options={
                'verbose_name': '抽查记录',
