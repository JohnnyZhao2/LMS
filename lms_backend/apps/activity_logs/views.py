...
class ActivityLogListView(BaseAPIView):
    ...
    def get(self, request):
        get_engine(request).enforce('activity_logs.view_activitylog', error_message='无权查看活动日志')
...
class ActivityLogPolicyView(BaseAPIView):
    ...
    def get(self, request):
        get_engine(request).enforce('activity_logs.change_activitylogpolicy', error_message='无权查看日志策略')
    ...
    def patch(self, request):
        get_engine(request).enforce('activity_logs.change_activitylogpolicy', error_message='无权更新日志策略')
...
class ActivityLogItemView(BaseAPIView):
    ...
    def delete(self, request, log_item_id: str):
        get_engine(request).enforce('activity_logs.view_activitylog', error_message='无权删除活动日志')
