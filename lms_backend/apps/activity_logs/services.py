...
_OPERATION_ACTION_SUMMARIES = {
    ...
    'create_spot_check': '{actor} 发起了抽查《{target}》',
    'update_spot_check': '{actor} 更新了 {target} 的抽查记录',
    'submit_spot_check': '{actor} 提交了抽查',
    'score_spot_check': '{actor} 评分了 {target} 的抽查',
    'delete_spot_check': '{actor} 删除了 {target} 的抽查记录',
    'manual_grade': '{actor} 批改了答卷',
    'batch_grade': '{actor} 批量评分',
    'replace_role_template': '{actor} 更新了角色模板《{target}》',
    'replace_user_authorization': '{actor} 更新了 {target} 的最终授权',
    'reset_user_authorization': '{actor} 重置了 {target} 的最终授权',
