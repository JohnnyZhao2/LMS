...
| `spot_checks` | `SpotCheck`<br>`SpotCheckItem` | `apps/spot_checks/services.py` | - | `apps/spot_checks/serializers.py` | `apps/spot_checks/views.py` | `apps/spot_checks/authorization.py` | 7 |
