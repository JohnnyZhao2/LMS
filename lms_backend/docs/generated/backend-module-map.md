...
| `authorization` | `Permission`<br>`RolePermission`<br>`UserPermissionOverride`<br>`UserScopeGroupOverride` | `apps/authorization/permission_catalog_service.py`<br>`apps/authorization/role_template_service.py`<br>`apps/authorization/services.py`<br>`apps/authorization/user_override_service.py` | `apps/authorization/selectors.py` | `apps/authorization/serializers.py` | `apps/authorization/views.py` | `apps/authorization/authorization.py` | 7 |
