...
import { MENU_ITEM_HOVER_CLASSNAME } from "@/components/ui/interactive-styles"
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-lg border-2 border-border bg-background p-1 text-foreground",
