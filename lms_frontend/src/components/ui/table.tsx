...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-14 px-6 text-left align-middle text-xs font-bold uppercase tracking-wider text-muted bg-muted [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-6 py-4 align-middle text-sm text-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
