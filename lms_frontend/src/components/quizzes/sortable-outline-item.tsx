  ...
  return (
    <div
      ...
      className={cn(
        ...
        displayMode === 'plain' ? 'border border-transparent bg-background py-0.5 hover:bg-transparent' : 'border border-border bg-background py-1.5',
        displayMode !== 'plain' && (isActive ? 'border-foreground/15 hover:border-primary-300' : 'hover:border-primary-300'),
    ...
    >
      ...
      >
        <div className="flex h-5 shrink-0 items-center justify-start text-[13px] font-medium leading-5 tabular-nums text-text-muted">
          {index + 1}
        </div>
        <div className="flex min-w-0 items-center">
          <div className={cn('line-clamp-1 text-[13px] leading-5', isActive ? 'text-foreground' : 'text-foreground/82')}>
