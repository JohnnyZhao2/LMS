...
import { normalizeScopeTypes, sameScopeTypes, sameScopeUserIds } from '@/features/authorization/components/user-form.utils';
import { normalizeScopeUserIds } from '@/features/authorization/components/user-permission-section.helpers';
import type { ScopeFilterOption } from '@/features/authorization/components/user-permission-section.types';
import {
...
import type { RoleScopeSelection } from '@/features/authorization/components/user-permission-scope.utils';
import type { ScopeGroupOverrideEntry } from '@/features/authorization/components/user-permission-section.types';
