...
import type { PermissionState } from '@/features/authorization/components/user-permission-section.types';
import type { PermissionOverrideEntry } from '@/features/authorization/components/user-permission-section.types';
