...
import { UserPermissionScopePopover } from '@/features/authorization/components/user-permission-scope-popover';
import { sameScopeTypes } from '@/features/authorization/components/user-form.utils';
import type { PermissionState, ScopeFilterOption } from '@/features/authorization/components/user-permission-section.types';
