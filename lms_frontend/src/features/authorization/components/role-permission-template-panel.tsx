...
export const RolePermissionTemplatePanel: React.FC<RolePermissionTemplatePanelProps> = ({
  ...
  return (
    <div className="flex flex-col gap-5">
      {/* 顶部控制栏：角色切换 + 操作 */}
      <section className="sticky top-0 z-10 rounded-xl border border-border bg-background backdrop-blur supports-[backdrop-filter]:bg-background">
      ...
      {isLoadingTemplate ? (
        <div className="flex items-center justify-center gap-2 rounded-2xl border border-border bg-muted px-6 py-16 text-sm text-text-muted">
