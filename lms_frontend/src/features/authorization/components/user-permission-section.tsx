...
import { getModulePresentation } from '@/features/authorization/lib/permission-presentation';
import { applyPermissionSelectionChange } from '@/features/authorization/lib/permission-dependencies';
