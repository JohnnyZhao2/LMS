...
import { useCreateUserPermissionOverride } from '@/features/authorization/api/create-user-permission-override';
import { useCreateUserScopeGroupOverride } from '@/features/authorization/api/create-user-scope-group-override';
...
} from '@/features/authorization/components/user-permission-section.helpers';
import type { PermissionOverrideEntry, ScopeGroupOverrideEntry } from '@/features/authorization/components/user-permission-section.types';
import { useUserPermissionOverrideState } from '@/features/authorization/components/use-user-permission-override-state';
import { useUserPermissionScopeState } from '@/features/authorization/components/use-user-permission-scope-state';
import { useUserScopeGroupOverrideState } from '@/features/authorization/components/use-user-scope-group-override-state';
import {
...
} from '@/features/authorization/components/user-permission-scope.utils';
import {
