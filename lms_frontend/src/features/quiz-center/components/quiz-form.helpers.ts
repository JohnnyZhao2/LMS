import { hasQuestionAnswer, normalizeQuestionScore } from '@/components/questions/question-editor-helpers';
import type { QuizCreateRequest, QuizType } from '@/types/quiz';

import type { InlineQuestionItem } from '@/components/quiz/quiz-editor-types';
