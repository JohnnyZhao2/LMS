...
import { UserPermissionWorkbench } from '@/features/user-management/components/authorization/user-permission-workbench';
...
import { RoleTemplateMemberPanel } from '@/features/user-management/components/authorization/role-template-member-panel';
import { useRolePermissionTemplateState } from '@/features/user-management/components/authorization/use-role-permission-template-state';
