...
import { getOverrideSignature } from '@/features/user-management/components/authorization/user-permission-section.helpers';
import type { PermissionOverrideEntry, PermissionState } from '@/features/user-management/components/authorization/user-permission-section.types';
import {
  buildPermissionTogglePlan,
  getRolePermissionOverrideBuckets,
  resolvePermissionState,
} from '@/features/user-management/components/authorization/user-permission-override.utils';
