...
import type { PermissionState } from '@/features/user-management/components/authorization/user-permission-section.types';
import type { PermissionOverrideEntry } from '@/features/user-management/components/authorization/user-permission-section.types';
