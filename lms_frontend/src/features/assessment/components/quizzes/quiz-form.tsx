...
import { buildQuizSubmitPayload, validateQuizDraft } from '@/features/assessment/components/quizzes/quiz-form.helpers';
import { QuizOutlinePanel } from '@/features/assessment/components/quizzes/quiz-outline-panel';
import { QuizPreviewWorkbench } from '@/features/assessment/components/quizzes/quiz-preview-workbench';
...
export const QuizForm: React.FC<QuizFormProps> = ({ tagDeps }) => {
  const { useTags, TagInput } = tagDeps;
